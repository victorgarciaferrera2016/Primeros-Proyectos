# -*- coding: utf-8 -*-
"""
Created on Mon Mar  4 02:28:07 2024
...
boston2 = boston.loc[:,['chas','nox', 'rm', 'age', 'dis', 'rad', 'tax','ptratio', 'b']]
print (boston2)
y = boston2['chas']
X = boston2.drop(columns='chas')
...
plt.xlabel('Modelos')
plt.ylabel('Valor')
plt.title('Comparación de Métricas por Modelo con algunsa variables Target balanceada')
